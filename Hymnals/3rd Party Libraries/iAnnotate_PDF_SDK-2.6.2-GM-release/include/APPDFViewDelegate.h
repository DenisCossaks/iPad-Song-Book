...
/**
 * This is used to allow for custom user notification when microphone is disabled.
 */
-(void)pdfControllerWasDeniedRecordAccess:(APPDFViewController *)controller;
...
/**
 * Notification that the user picked a color, called when the color picker
 * displayed by APPDFViewController::showColorPicker is dismissed.
 *
 * \sa APPDFViewController::showColorPickerFromRect:inView:animated:withColor:allowAlpha:
 * \sa APPDFViewController::showColorPickerFromBarButtonItem:animated:withColor:allowAlpha:
 */
-(void)pdfController:(APPDFViewController *)controller didPickColor:(UIColor *)color;
