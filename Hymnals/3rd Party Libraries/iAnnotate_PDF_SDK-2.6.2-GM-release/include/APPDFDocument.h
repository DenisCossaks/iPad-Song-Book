...
/**
 * Document language.
 * A language identifier conforming to RFC 3066 (e.g., "en-US" or "es-Mx"), if marked in the PDF.  
 * Should be interpretted in a case insensitive way.  
 * This may be empty if the PDF does not specify a language.  
 * This also may be over-ridden in local regions of the PDF by more granular language tags.
 */
